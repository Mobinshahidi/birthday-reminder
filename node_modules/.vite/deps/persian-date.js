...
var require_persian_date = __commonJS({
  "node_modules/persian-date/dist/persian-date.js"(exports, module) {
        ...
        function(modules) {
            ...
            var Helpers = function() {
              ...
              _createClass(Helpers2, [{
                ...
                value: function toPersianDigit(digit) {
                  var latinDigit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
                  return digit.toString().replace(/\d+/g, function(digit2) {
                    var enDigitArr = [], peDigitArr = [], i = void 0, j = void 0;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var PersianDateClass = function() {
              function PersianDateClass2(input) {
                _classCallCheck(this, PersianDateClass2);
                this.calendarType = PersianDateClass2.calendarType;
                this.localType = PersianDateClass2.localType;
                this.leapYearMode = PersianDateClass2.leapYearMode;
              ...
              _createClass(PersianDateClass2, [{
                key: "setup",
                value: function setup(input) {
                  ...
                  } else if (input instanceof PersianDateClass2) {
                ...
                value: function _getSyncedClass(input) {
                  var syncedCelander = PersianDateClass2.toCalendar(this.calendarType).toLocale(this.localType).toLeapYearMode(this.leapYearMode);
                ...
                value: function isPersianDate(obj) {
                  return obj instanceof PersianDateClass2;
                }
                /**
                 * @returns {PersianDate}
                 */
                ...
                value: function diff(input, val, asFloat) {
                  var self = this, inputMoment = input, zoneDiff = 0, diff2 = self.State.gDate - inputMoment.toDate() - zoneDiff, year = self.year() - inputMoment.year(), month = self.month() - inputMoment.month(), date = (self.date() - inputMoment.date()) * -1, output = void 0;
                  if (val === "months" || val === "month") {
                    output = year * 12 + month + date / 30;
                  } else if (val === "years" || val === "year") {
                    output = year + (month + date / 30) / 12;
                  } else {
                    output = val === "seconds" || val === "second" ? diff2 / 1e3 : (
                      // 1000
                      val === "minutes" || val === "minute" ? diff2 / 6e4 : (
                        // 1000 * 60
                        val === "hours" || val === "hour" ? diff2 / 36e5 : (
                          // 1000 * 60 * 60
                          val === "days" || val === "day" ? diff2 / 864e5 : (
                            // 1000 * 60 * 60 * 24
                            val === "weeks" || val === "week" ? diff2 / 6048e5 : (
                              // 1000 * 60 * 60 * 24 * 7
                              diff2
                            )
                          )
                ...
                value: function startOf(key) {
                  var syncedCelander = PersianDateClass2.toCalendar(this.calendarType).toLocale(this.localType);
                  var newArray = new PersianDateClass2(this.valueOf() - (this.calendar().weekday - 1) * 864e5).toArray();
                  switch (key) {
                    case "years":
                    case "year":
                ...
                value: function local() {
                  ...
                  if (this._utcMode) {
                    ...
                    var offsetMils = ThatDayOffset * 60 * 1e3;
                    if (ThatDayOffset < 0) {
                      utcStamp = this.valueOf() - offsetMils;
                    } else {
                      utcStamp = this.valueOf() + offsetMils;
                    }
                    this.toCalendar(PersianDateClass2.calendarType);
                ...
                value: function utc(input) {
                  ...
                  if (this._utcMode) {
                    ...
                    var offsetMils = this.zone() * 60 * 1e3;
                    if (this.zone() < 0) {
                      utcStamp = this.valueOf() + offsetMils;
                    } else {
                      utcStamp = this.valueOf() - offsetMils;
                    }
                    var utcDate = new Date(utcStamp), d = this._getSyncedClass(utcDate);
                ...
                value: function isDST() {
                  var month = this.month(), day = this.date();
                ...
                value: function daysInMonth(yearInput, monthInput) {
                  var year = yearInput ? yearInput : this.year(), month = monthInput ? monthInput : this.month();
                  if (this.calendarType === "persian") {
                    if (month < 1 || month > 12)
                      return 0;
                    if (month < 7)
                ...
                value: function format(inputString) {
                  ...
                  var self = this, formattingTokens = /([[^[]*])|(\\)?(Mo|MM?M?M?|Do|DD?D?D?|dddddd?|ddddd?|dddd?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|zz?|ZZ?|X|LT|ll?l?l?|LL?L?L?)/g, info = {
                    year: self.year(),
                    month: self.month(),
                    hour: self.hours(),
                    minute: self.minutes(),
                  ...
                  var checkPersian = function checkPersian2(i) {
                    if (formatToPersian) {
                  ...
                  function replaceFunction(input) {
                    switch (input) {
                      ...
                      case "w": {
                        var _t2 = self.startOf("year"), day = parseInt(self.diff(_t2, "days") / 7) + 1;
                        return checkPersian(day);
                      }
                      case "ww": {
                        var _t3 = self.startOf("year"), _day = leftZeroFill(parseInt(self.diff(_t3, "days") / 7) + 1, 2);
                      ...
                      case "Z": {
                        var flag = "+", hours = Math.round(info.timezone / 60), minutes = info.timezone % 60;
                        if (minutes < 0) {
                          minutes *= -1;
                        }
                        if (hours < 0) {
                      ...
                      case "ZZ": {
                        var _flag = "+", _hours = Math.round(info.timezone / 60), _minutes = info.timezone % 60;
                        if (_minutes < 0) {
                          _minutes *= -1;
                        }
                        if (_hours < 0) {
                ...
                value: function add(key, value) {
                  ...
                  var unit = normalizeDuration(key, value).unit, arr = this.toArray();
                  value = normalizeDuration(key, value).value;
                  if (unit === "year") {
                    var normalizedDate = arr[2], monthDays = this.daysInMonth(arr[0] + value, arr[1]);
                    if (arr[2] > monthDays) {
                      normalizedDate = monthDays;
                    }
                    var tempDate = new PersianDateClass2([arr[0] + value, arr[1], normalizedDate, arr[3], arr[4], arr[5], arr[6], arr[7]]);
                    return tempDate;
                  }
                  if (unit === "month") {
                    var tempYear = Math.floor(value / 12);
                    var remainingMonth = value - tempYear * 12, calcedMonth = null;
                    ...
                    var normalizaedDate = arr[2], tempDateArray = new PersianDateClass2([arr[0] + tempYear, calcedMonth, 1, arr[3], arr[4], arr[5], arr[6], arr[7]]).toArray(), _monthDays = this.daysInMonth(arr[0] + tempYear, calcedMonth);
                    if (arr[2] > _monthDays) {
                      normalizaedDate = _monthDays;
                    }
                    return new PersianDateClass2([tempDateArray[0], tempDateArray[1], normalizaedDate, tempDateArray[3], tempDateArray[4], tempDateArray[5], tempDateArray[6], tempDateArray[7]]);
                  }
                  if (unit === "day") {
                    var calcedDay = new PersianDateClass2(this.valueOf()).hour(12), newMillisecond = calcedDay.valueOf() + value * 864e5, newDate = new PersianDateClass2(newMillisecond);
                    return newDate.hour(arr[3]);
                  }
                  if (unit === "week") {
                    var _calcedDay = new PersianDateClass2(this.valueOf()).hour(12), _newMillisecond = _calcedDay.valueOf() + 7 * value * 864e5, _newDate = new PersianDateClass2(_newMillisecond);
                    return _newDate.hour(arr[3]);
                  }
                  if (unit === "hour") {
                    var _newMillisecond2 = this.valueOf() + value * 36e5;
                    return this.unix(_newMillisecond2 / 1e3);
                  }
                  if (unit === "minute") {
                    var _newMillisecond3 = this.valueOf() + value * 6e4;
                    return this.unix(_newMillisecond3 / 1e3);
                  }
                  if (unit === "second") {
                    var _newMillisecond4 = this.valueOf() + value * 1e3;
                    return this.unix(_newMillisecond4 / 1e3);
                  }
                  if (unit === "millisecond") {
                    var _newMillisecond5 = this.valueOf() + value;
                    return this.unix(_newMillisecond5 / 1e3);
                  }
                ...
                key: "rangeName",
                value: function rangeName() {
                  var p = PersianDateClass2, t = p.calendarType;
                  if (p.localType === "fa") {
                    if (t === "persian") {
                      return fa.persian;
                    } else {
                ...
                value: function unix(timestamp) {
                  if (timestamp) {
                    return new PersianDateClass2(timestamp * 1e3);
                  } else {
                    return new PersianDateClass2().unix();
                  }
                }
              }, {
                key: "getFirstWeekDayOfMonth",
                value: function getFirstWeekDayOfMonth(year, month) {
                  return new PersianDateClass2([year, month, 1]).day();
                }
              }, {
                key: "utc",
                value: function utc(input) {
                  if (input) {
                    return new PersianDateClass2(input).utc();
                  } else {
                    return new PersianDateClass2().utc();
                  }
                }
              }, {
                key: "isSameDay",
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Algorithms = function() {
              function Algorithms2(parent) {
                _classCallCheck(this, Algorithms2);
                this.parent = parent;
              ...
              _createClass(Algorithms2, [{
                ...
                value: function jd_to_gregorian(jd) {
                  var wjd = void 0, depoch = void 0, quadricent = void 0, dqc = void 0, cent = void 0, dcent = void 0, quad = void 0, dquad = void 0, yindex = void 0, year = void 0, yearday = void 0, leapadj = void 0, month = void 0, day = void 0;
                ...
                value: function tehran_equinox(year) {
                  var equJED = void 0, equJD = void 0, equAPP = void 0, equTehran = void 0, dtTehran = void 0;
                ...
                value: function persiana_year(jd) {
                  var guess = this.jd_to_gregorian(jd)[0] - 2, lasteq = void 0, nexteq = void 0, adr = void 0;
                ...
                value: function jd_to_persiana(jd) {
                  var year = void 0, month = void 0, day = void 0, adr = void 0, equinox = void 0, yday = void 0;
                ...
                value: function persiana_to_jd(year, month, day) {
                  var adr = void 0, equinox = void 0, guess = void 0, jd = void 0;
                ...
                value: function persian_to_jd(year, month, day) {
                  var epbase = void 0, epyear = void 0;
                ...
                value: function jd_to_persian(jd) {
                  var year = void 0, month = void 0, day = void 0, depoch = void 0, cycle = void 0, cyear = void 0, ycycle = void 0, aux1 = void 0, aux2 = void 0, yday = void 0;
                  jd = Math.floor(jd) + 0.5;
                ...
                value: function updateFromGregorian() {
                  var j = void 0, year = void 0, mon = void 0, mday = void 0, hour = void 0, min = void 0, sec = void 0, weekday = void 0, utime = void 0, perscal = void 0;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var ASTRO = function() {
              function ASTRO2() {
                ...
                this.JDE0tab1000 = [new Array(172113929189e-5, 365242.1374, 0.06134, 111e-5, -71e-5), new Array(172123325401e-5, 365241.72562, -0.05323, 907e-5, 25e-5), new Array(172132570455e-5, 365242.49558, -0.11677, -297e-5, 74e-5), new Array(172141439987e-5, 365242.88257, -769e-5, -933e-5, -6e-5)];
                this.JDE0tab2000 = [new Array(245162380984e-5, 365242.37404, 0.05169, -411e-5, -57e-5), new Array(245171656767e-5, 365241.62603, 325e-5, 888e-5, -3e-4), new Array(245181021715e-5, 365242.01767, -0.11575, 337e-5, 78e-5), new Array(245190005952e-5, 365242.74049, -0.06223, -823e-5, 32e-5)];
              }
              _createClass(ASTRO2, [{
                key: "dtr",
                ...
                value: function equinox(year, which) {
                  var deltaL = void 0, i = void 0, j = void 0, JDE0 = void 0, JDE = void 0, JDE0tab = void 0, S = void 0, T = void 0, W = void 0, Y = void 0;
                  if (year < 1e3) {
                ...
                value: function sunpos(jd) {
                  var T = void 0, T2 = void 0, L0 = void 0, M = void 0, e = void 0, C = void 0, sunLong = void 0, sunAnomaly = void 0, sunR = void 0, Omega = void 0, Lambda = void 0, epsilon = void 0, epsilon0 = void 0, Alpha = void 0, Delta = void 0, AlphaApp = void 0, DeltaApp = void 0;
                ...
                value: function equationOfTime(jd) {
                  var alpha = void 0, deltaPsi = void 0, E = void 0, epsilon = void 0, L0 = void 0, tau = void 0;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Duration = function() {
              function Duration2(key, value) {
                _classCallCheck(this, Duration2);
                var duration = {}, data = this._data = {}, milliseconds = 0, normalizedUnit = normalizeDuration(key, value), unit = normalizedUnit.unit;
                duration[unit] = normalizedUnit.value;
                milliseconds = duration.milliseconds || duration.millisecond || duration.ms || 0;
                var years = duration.years || duration.year || duration.y || 0, months = duration.months || duration.month || duration.M || 0, weeks = duration.weeks || duration.w || duration.week || 0, days = duration.days || duration.d || duration.day || 0, hours = duration.hours || duration.hour || duration.h || 0, minutes = duration.minutes || duration.minute || duration.m || 0, seconds = duration.seconds || duration.second || duration.s || 0;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Container = function Container2() {
...
export default require_persian_date();
